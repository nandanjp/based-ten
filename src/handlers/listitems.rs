...
pub async fn get_list_item(
    ...
    match ListItemService::get_list_item(&pool, user_name, list_name, item_id).await {
        Ok(list_item) => (
            StatusCode::OK,
...
pub async fn update_list_item(
    ...
    match ListItemService::update_list_item(&pool, update_obj, user_name, list_name, item_id).await
    {
        Ok(list_item) => (
            StatusCode::OK,
            Json(ListItemResponse {
...
pub async fn delete_list_item(
    ...
    match ListItemService::delete_list_item(&pool, user_name, list_name, item_id).await {
        Ok(list_item) => (
            StatusCode::OK,
            Json(ListItemResponse {
                success: true,
