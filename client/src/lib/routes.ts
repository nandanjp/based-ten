...
export const ROUTES = {
  ...
  users: {
    ...
    get_likes: (user_name: string) => `/users/${user_name}/likes`,
    protected: {
  ...
  listitems: {
    protected: {
      create_list_item: (list_name: string, item_id: string) =>
        `/listitems/${list_name}/${item_id}`,
    },
  },
  likes: {
    get_likes: "/likes",
  ...
  groups: {
    ...
    get_group_by_ownername: (user_name: string) =>
      `/groups/${user_name}/groups`,
    get_group_by_username: (user_name: string) =>
      `/groups/${user_name}/group_members`,
