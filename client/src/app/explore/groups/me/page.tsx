...
const ExplorePage = () => {
  ...
  return (
    <div className="flex flex-1 flex-col justify-between items-center min-h-full min-w-full">
      ...
      <div className="flex self-center flex-col p-4 gap-8 max-w-screen-sm md:max-w-7xl xl:max-w-screen-xl flex-1 mt-10">
        <Card className="min-w-full shadow-md py-8 px-3">
          <CardHeader>
